...
import com.football.challengemyteams.databinding.CardCountryCategoryBinding
import com.football.challengemyteams.fragments.SportCategoryFragmentDirections
import com.football.challengemyteams.model.BodySportCategories
    ...
    override fun onBindViewHolder(holder: ToDoViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            cardCategories.setOnClickListener {
                ...
                Navigation.findNavController(it).navigate(SportCategoryFragmentDirections.actionSportCategoryFragmentToCountryFragment())
            }
