...
import com.football.challengemyteams.fragments.CountryFragmentDirections
import com.football.challengemyteams.model.BodyCountries
    ...
    override fun onBindViewHolder(holder: ToDoViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            cardCategories.setOnClickListener {
                ...
                Navigation.findNavController(it).navigate(CountryFragmentDirections.actionCountryFragmentToMatchListFragment())
            }
