...
import com.football.challengemyteams.fragments.MatchListFragmentDirections
import com.football.challengemyteams.model.Body
    ...
    override fun onBindViewHolder(holder: ToDoViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            cardSport.setOnClickListener {
                Navigation.findNavController(it).navigate(MatchListFragmentDirections.actionMatchListFragmentToDetailFragment(currentToDo[0]))
            }
        }
    }
